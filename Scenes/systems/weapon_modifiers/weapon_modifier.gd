...
## Accepts a value and applies this WeaponModifier values to it. Returns the resulting value.
...
## Adds a value to this WeaponModifier's flat_mod_value
func add_flat_mod_value(value):
	flat_mod_value += value


## Subtracts a value from this WeaponModifier's flat_mod_value
func subtract_flat_mod_value(value):
	flat_mod_value -= value


## Adds a value to this WeaponModifiers increased_mod_value
func add_increased_mod_value(value):
	increased_mod_value += value


## Subtracts a value from this WeaponModifiers increased_mod_value
func subtract_increased_mod_value(value):
	increased_mod_value -= value


## Adds a value to this WeaponModifiers more_mod_value (stacks multiplicatively)
func add_more_mod_value(value):
	more_mod_value *= (1.0 + value)


## Subtracts a value from this WeaponModifiers more_mod_value (stacks multiplicatively)
